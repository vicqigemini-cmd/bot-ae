# ==============================================================================
#  🤖 SENTINEL ZERO-TOUCH UNIVERSAL AUTO-UPDATER (RDP 24/7)
#  Mengupdate & Mengompilasi XAUUSD_AI_Brain_EA & Discord_Sentinel_EA_MT5
# ==============================================================================
...
Write-Host " Memantau update & auto-compile semua file EA di background" -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
...
while ($true) {
    ...
    try {
        ...
        if ($currentSha -ne $lastSha -and $currentSha -ne "") {
            ...
            Write-Host "[$timeStr] 📥 1. File EA MQ5 berhasil diunduh!" -ForegroundColor Green
            ...
            if ($metaEditorPath -and (Test-Path $metaEditorPath)) {
                ...
                Write-Host "[$timeStr] ✅ 2. Kompilasi kedua file EA sukses!" -ForegroundColor Green
            }
            ...
            if ($runningProc) {
                ...
                Write-Host "[$timeStr] 🔄 3. Me-reload MetaTrader 5 ($termPath)..." -ForegroundColor Yellow
                ...
                # Jika terminal belum terbuka, cari di folder Program Files
                $defaultTerm = Get-ChildItem -Path "C:\Program Files*" -Include "terminal64.exe", "terminal.exe" -Recurse -ErrorAction SilentlyContinue | Select-Object -First 1 -ExpandProperty FullName
                if ($defaultTerm -and (Test-Path $defaultTerm)) {
                    Start-Process -FilePath $defaultTerm
                    Write-Host "[$timeStr] 🎉 3. MetaTrader 5 diluncurkan otomatis!" -ForegroundColor Green
                }
            }

            Write-Host "[$timeStr] 🚀 PROSES ZERO-TOUCH 100% SUKSES!`n" -ForegroundColor Cyan
            $lastSha = $currentSha
        } else {
